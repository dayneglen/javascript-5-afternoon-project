...
let dayne = new Employee('dayne', 'porter', 'dayne@dayne.com', 26);
...
class Manager extends Employee {
  ...
  fire(index){
    this.reports = this.reports.filter((_, i) => index !== i);
  }
}

let jessica = new Manager('Jessica', 'Dover', 'jessicaisimportant@jessica.com', 88);
////////// PROBLEM 3 //////////
...
let david = new ProgressiveManager('David', 'Stevens', 'david@david.com', 43);
...
let cinder = new Machine();

cinder.makeWidgets(504)
cinder.fixMachine();
console.log(cinder)
cinder.reboot()();
console.log(cinder)